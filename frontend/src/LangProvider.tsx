...
export const LangContext = createContext<langCtx>({ language: initialLanguage, updateLanguage: () => { }, translate: () => '' });
...
type transKeys = 'ip' | 'invalidIP' | 'leaveBlankForCurrentIP' | 'locate' | 'ipLocation';
